...
contract AntfarmPosition is IAntfarmPosition, ERC721Enumerable {
        ...
        returns (uint256 claimedAmount)
    {
        for (uint256 i; i < positionIds.length; i++) {
            claimedAmount += claimDividend(positionIds[i]);
        }
    }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://testnet.antfarm.finance/positions/metadata/";
    }
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            token0 == antfarmToken
                                ? hex"ca07d07d283af362cb0ef49fa78c35d700ddf86c6aaac839c077c6e4922d810e"
                                : hex"ee477e2fa7c0b162f152c097c23c3168c4e2b130b671db76097bda8cd3c8d45b" // init code hash
                        )
                    )
                )
            )
